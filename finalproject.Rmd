...
Here is the formula for the model, model output in Model 2 section in Appendix, the reason to add 1 in log is to avoid some zero value for those variables because log is not defined at 0:
...
\begin{align*}
Rating = \beta_0 + \beta_1 \cdot log(Reviews+1)+\beta_2 \cdot log(Installs+1)+\\\beta_3 \cdot TypePaid+\beta_4 \cdot log(Price+1)+\\\beta_5 \cdot Category+\beta_6 \cdot Content.Rating+\\\beta_7 \cdot Last.Updated+\beta_8 \cdot Size
\end{align*}
...
\begin{align*}
Rating = \beta_1 \cdot log(Reviews+1)+\beta_2 \cdot log(Installs+1)+\\\beta_3 \cdot TypePaid+\beta_4 \cdot log(Price+1)+\\\beta_5 \cdot Category+\beta_6 \cdot Content.Rating+\\\beta_7 \cdot Last.Updated+\beta_8 \cdot Size
\end{align*}
...
\begin{align*}
Rating = \beta_1 \cdot log(Reviews+1)+\beta_2 \cdot log(Installs+1)+\\\beta_3 \cdot TypePaid+\beta_4 \cdot log(Price+1)+\beta_5 \cdot Content.Rating+\\\beta_6 \cdot Last.Updated+\beta_7 \cdot Size+(1|Category)
\end{align*}
...
\begin{align*}
Rating = \beta_1 \cdot log(Reviews+1)+\beta_2 \cdot log(Installs+1)+\\\beta_3 \cdot TypePaid+\beta_4 \cdot log(Price+1)+\beta_5 \cdot Content.Rating+\\\beta_6 \cdot Last.Updated+\beta_7 \cdot Size
\end{align*}
...
\begin{align*}
Rating = \beta_1 \cdot log(Reviews+1)+\beta_2 \cdot log(Installs+1)+\\\beta_3 \cdot TypePaid+\beta_4 \cdot log(Price+1)+\beta_5 \cdot Content.Rating+\\\beta_6 \cdot Last.Updated+\beta_7 \cdot Size+\beta_8 \cdot Category+\beta_9 \cdot Size*Type
\end{align*}
